<?php
class Pt_api extends CI_Controller {
    ...
    public function get_player_info() {
        $this -> load -> library('playtech');
        $this -> playtech -> get_player_info('BFPTtest222');
    }
    ...
    public function login() {
        ...
        $this -> load -> view('admin/pt_api/pt_login', $data);
    }
    ...
    public function exports() {
     ...
     public function errors() {
        $this -> load -> library('playtech');
        echo print_r($this -> playtech -> errors(),TRUE);

    }
     
	 //날짜에서 분과 초는 00으로 해야 정상 작동(날짜와 시간단위만 작성 할것)
     public function get_game_stats1(){
        $this -> load -> library('playtech');
        $start_date = '2015-10-01 16:00:00';
        $end_date   = '2015-10-31 23:00:00';
     ...
     public function get_game_stats2(){
        $this -> load -> library('playtech');
        $start_date = '2015-08-19 00:00:00';
        $end_date   = '2015-08-19 23:59:59';
        $player_name = "BFPTtopayc0011";
        $player_name = strtoupper($player_name);
