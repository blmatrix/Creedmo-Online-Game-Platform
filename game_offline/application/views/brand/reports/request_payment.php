	...
	<section role="main" class="content-body">
		...
		<section class="panel">
			<header class="panel-heading">
               <h2 class="panel-title">정산금액 출금 신청</h2>
           </header>
							...
							<div class="panel-body">
								 ...
								 <div class="row">
											...
											<div class="panel-body bg-secondary">
												<div class="widget-summary">
													...
													<div class="widget-summary-col">
														<div class="summary">
															<h4 class="title">지금까지 토탈 정산금</h4>
															<div class="info">
																<strong class="amount"><?= number_format($total_compllete_payment -> sum,0 )?> 원</strong>
															</div>
														</div>
										...
										<section class="panel">
											<div class="panel-body bg-tertiary">
												<div class="widget-summary">
													...
													<div class="widget-summary-col">
														<div class="summary">
															<h4 class="title">출금 가능 정산금</h4>
															<div class="info">
																<strong class="amount"><?= number_format($wallet -> agent_settlement_balance,0)?> 원</strong>
															</div>
														</div>
														<div class="summary-footer">
															현재 출금 가능 금액
									...
									<a  id ="request_payment" data-url="<?= site_url('brand/reports/form/request_payment') ?>" class="btn btn-primary pull-right" role="button">
									    정산금 출금 신청하기 <i class="fa fa-plus"></i>
									</a>
									</div>
								</div>							
								...
								<table class="table table-striped">
									...
									<tr height="30px">
										...
										<th class="hidden-xs hidden-sm">은행명</th>
										<th class="hidden-xs hidden-sm">계좌번호</th>
										<th width="110px" class="text-right">출금신청액</th>
										<th class="text-right hidden-xs">요청일</th>
										<th class="text-right">완료일</th>
...
<?php foreach($request_payments as $request_payment):?>									    
										<tr  class ="">
											...
											<td class="text-right text-danger"><h4 class="text-weight-bold" style="margin:0"><?= number_format($request_payment -> settlement_amount,0)?></h4></td>
