 ...
 <?php include_once  APPPATH ."views\\admin\\template\\top.php"; ?>
						...
						<div class="nano-content">
							<nav id="menu" class="nav-main" role="navigation">
								<ul class="nav nav-main">
									...
									<li>
										<a href="withdraw-list.html">
											<span class="pull-right label label-primary">120</span>
											<i class="fa fa-money" aria-hidden="true"></i>
											<span>Withdraw  </span>
										</a>
									</li>
									<li>
										<a href="transfer-record.html">
											<span class="pull-right label label-primary">92</span>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="profit-report.html">
													 Profit Report
												</a>
											</li>
											<li>
												<a href="credit-transfer.html">
													 Credit Transfer
												</a>
											</li>
											<li>
									...
									<li class="nav-parent">
										...
										<ul class="nav nav-children">
											<li>
												<a href="agent-list.html">
													 Agents
												</a>
											</li>
											<li>
												<a href="settle-account.html">
									...
									<li>
										<a href="ui-elements-typography.html" target="_blank">
											<i class="fa fa-external-link" aria-hidden="true"></i>
											<span>SMAMPLE <em class="not-included">(Sample Page)</em></span>
										</a>
									</li>
								</ul>
							</nav>
							...
							<div class="sidebar-widget widget-stats">
								<div class="widget-header">
									<h6>Game Money Stats</h6>
									<div class="widget-toggle">+</div>
								</div>
								<div class="widget-content">
									<ul>
										<li>
											<span class="stats-title">MG Casino Balance <a href="#" class="link">Request</a></span><br>
											<span class="stats-title">320,000 CNY / 1,000,000 CNY</span>
											<span class="stats-complete">85%</span><br>
											<div class="progress">
				...
				<section role="main" class="content-body">
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							...
							<a class="sidebar-right-toggle"  href="#"><i class="fa fa-chevron-left"></i></a>
						</div>
					</header>
										...
										<div class="col-lg-8">
											<div class="chart-data-selector" id="salesSelectorWrapper">
												<h2>
													...
													<strong>
														<select class="form-control" id="salesSelector">
															<option value="Total Profit" selected>Total Profit</option>
												...
												<div id="salesSelectorItems" class="chart-data-selector-items mt-sm">
													<!-- Flot: Sales Total Profit -->
													<div class="chart chart-sm" data-sales-rel="Total Profit" id="flotDashSales1" class="chart-active"></div>
													<script>
														...
														// See: <?=base_url('assets/');?>/javascripts/dashboard/examples.dashboard.js for more settings.

													</script>

													<!-- Flot: Sales Microgaming -->
													<div class="chart chart-sm" data-sales-rel="Microgaming" id="flotDashSales2" class="chart-hidden"></div>
													<script>
													...
													<!-- Flot: Sales Playtech -->
													<div class="chart chart-sm" data-sales-rel="Playtech" id="flotDashSales3" class="chart-hidden"></div>
													<script>
										...
										<div class="col-lg-4 text-center">
											...
											<div class="liquid-meter-wrapper liquid-meter-sm mt-lg">
												...
												<div class="liquid-meter-selector" id="meterSalesSel">
													<a href="#" data-val="35" class="active">Weekly Goal</a>
													<a href="#" data-val="28">Monthly Goal</a>
												</div>
											</div>
										</div>
									</div>
										...
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">Today Profit</h4>
														<div class="info">
															<strong class="amount">40,365,000 CNY</strong>
									...
									<section class="panel panel-featured-left panel-featured-secondary">
										<div class="panel-body">
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														<h4 class="title">This Week Profit</h4>
														<div class="info">
															<strong class="amount">950,365,000 CNY</strong>
														</div>
													</div>
													<div class="summary-footer">
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="info">
															<strong class="amount">5,696/335</strong>
														</div>
													</div>
													<div class="summary-footer">
														<a class="text-muted text-uppercase">(Report)</a>
										...
										<header class="panel-heading bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="<?=base_url('assets/');?>/images/!logged-user.jpg">
												</div>
												...
												<li>
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="<?=base_url('assets/');?>/images/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-responsive" width="215" src="<?=base_url('assets/');?>/images/projects/project-4.jpg">
																<span class="zoom">
 ...
 <?php include_once  APPPATH ."views\\admin\\template\\footer.php"; ?>