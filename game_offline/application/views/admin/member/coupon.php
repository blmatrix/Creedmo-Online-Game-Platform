...
<?php endforeach;?>												  
                                                ...
                                                <select id="coupon_use_status" name ="coupon_use_status" class="form-control">
                                                    <option value ="">쿠폰상태</option>
                                                    <option value ="">----------------</option>
                                                    <option value ="1" <?= $coupon_use_status  == 1 ? "selected":''?> >사용전</option>
                                                    <option value ="2" <?= $coupon_use_status  == 2 ? "selected":''?> >사용</option>
                                                </select>
												<a href="#"  data-url = "<?= site_url('admin/member/form')?>?request_form=coupon&request_type=create" class="btn btn-primary  pull-right coupon-create" role="button">쿠폰발급  <i class="fa fa-plus"></i></a>
										</div>	
									</div>								
								...
								<h4 class="text-weight-bold text-dark text-uppercase">개요 &nbsp;
...
<?php endforeach;?>     											
								...
								<table class="table table-striped">
									...
									<tr height="30px">
										...
										<th class="text-right">사용현황</th>
										<th class="text-right hidden-xs hidden-sm">발급</th>
										<th class="text-right hidden-xs hidden-sm">사용</th>
										<th class="text-right hidden-xs hidden-sm">발급자</th>
									</tr>
									</thead>
									<tbody>
