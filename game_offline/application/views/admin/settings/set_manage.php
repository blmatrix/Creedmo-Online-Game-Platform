				...
				<section role="main" class="content-body">
					...
					<div class="row">
							...
							<section class="panel-featured panel-featured-primary">
								...
								<div class="panel-body">
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												<label class="control-label">카카오톡 ID</label>
									...
									<hr>
										...
										<div class="form-group">
											<label class="col-sm-4 control-label">Join Greeting Message<br>사용안함</label>
											<div class="col-sm-8">
								...
								<footer class="panel-footer">
									<button type = "button" class="mb-sm mt-sm mr-sm btn btn-primary btn-block manage-setting" data-request-type = "customer_service">수정하기</button>
								</footer>
							</section>
						</div>
						...
						<div class="col-md-6">
								...
								<section class="panel-featured panel-featured-primary">
									<header class="panel-heading">
										<h2 class="panel-title">사이트 기본 입/출금 정책</h2>
									...
									<div class="panel-body">
										<div class="col-md-12">
											<div class="form-group">
												<label class="col-sm-5 control-label">최소 입금액</label>
													<div class="input-group col-sm-6">
														<input type="text" class="form-control input-sm"  disabled value = "<?= $casino_basic_policy -> min_per_deposit?>">
														<span class="input-group-addon btn-warning">Krw</span>
													</div>
											</div>
											<div class="form-group">
												<label class="col-sm-5 control-label">최대 입금액</label>
													<div class="input-group col-sm-6">
											...
											<div class="form-group">
												<label class="col-sm-5 control-label">최소 출금액</label>
													<div class="input-group col-sm-6">
											...
											<div class="form-group">
												<label class="col-sm-5 control-label">최대 출금액</label>
													<div class="input-group col-sm-6">
											...
											<div class="form-group">
												<label class="col-sm-5 control-label">가입 후 첫 입금 보너스</label>
													<div class="input-group col-sm-6">
														<div data-plugin-spinner data-plugin-options='{ "value":5, "min": 5, "max": 15 }'>
															...
															value set  <code>최소 5%</code> 에서  <code>최대 15%</code>  
														
													</div>
											</div>
											<div class="form-group">
												<label class="col-sm-5 control-label">첫입금 보너스 죄대 금액</label>
													<div class="input-group col-sm-6">
									...
									<footer class="panel-footer">
										<button type = "button" class="mb-sm mt-sm mr-sm btn btn-primary btn-block manage-setting" data-request-type = "casino_policy" >수정하기</button>
									</footer>
								</section>
					...
					<div class="row">
						...
						<div class="col-md-6">
							<section class="panel-featured panel-featured-primary">
								<header class="panel-heading">
									<h2 class="panel-title">파트너 페이지 고객센터 정보</h2>
								...
								<footer class="panel-footer">
									<button type = "button" class="mb-sm mt-sm mr-sm btn btn-primary btn-block manage-setting" data-request-type = "affiliate_information" >수정하기</button>
								</footer>
							</section>
						</div>
						...
						<div class="col-md-6">
								...
								<section class="panel-featured panel-featured-primary">
									<header class="panel-heading">
										<h2 class="panel-title">콤프포인트 정책</h2>
										<p class="panel-subtitle">콤프포인트 전환율</p>
										
									</header>
									<div class="panel-body">
										<div class="col-md-12">
											<div class="form-group">
												<label class="col-sm-5 control-label">Slots 전환율 1P</label>
													<div class="input-group col-sm-6">
											...
											<div class="form-group">
												<label class="col-sm-5 control-label">Non Slots 전환율 1P</label>
													<div class="input-group col-sm-6">
											...
											<div class="form-group">
												<label class="col-sm-5 control-label">Live 전환율 1P</label>
													<div class="input-group col-sm-6">
									...
									<footer class="panel-footer">
										<button type = "button" class="mb-sm mt-sm mr-sm btn btn-primary btn-block manage-setting" data-request-type = "comp_conversion_policy" >수정하기</button>
									</footer>
								</section>
					...
					<div class="row">
						...
						<div class="col-md-12">
							<section class="panel-featured panel-featured-warning">
								<header class="panel-heading">
									<h2 class="panel-title">유저 레벨 정책</h2>
...
<?php foreach($user_levels as $user_level):?>
														...
														<tr>
															...
															<td><div class="input-group"><input type="text" name = "level[<?= $user_level -> user_level_no?>][deposit_bonus_limit]"    class="form-control input-sm" value = "<?= $user_level -> deposit_bonus_limit?>"  ><span class="input-group-addon btn-warning"><i class="fa fa-rmb"></i></span></div></td>
														</tr>
<?php endforeach;?>														
													</tbody>
												</table>
								...
								<footer class="panel-footer">
									<button type = "button" class="mb-sm mt-sm mr-sm btn btn-warning btn-block manage-setting" data-request-type = "user_level_policy" >수정하기</button>
								</footer>
							</section>
						</div>
						...
						<div class="col-md-12">
							<section class="panel-featured panel-featured-danger">
								<header class="panel-heading">
									...
									<h2 class="panel-title">파트너 프로그램 정책</h2>

									<p class="panel-subtitle">
										파트너 수익 수수료 - <span class="text-danger">Only allow NUMERIC</span>
									</p>
								</header>
								<div class="panel-body">
