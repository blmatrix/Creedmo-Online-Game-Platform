                ...
                <div class="column750px Mainform-container">
                    <div id="member_container">
                        ...
                        <ul class="MemberTabs">
							...
							<li  style ="display:none" class="MemberTabs-link <?=$tab == 'transfer_history'? 'current' :'' ?>" data-tab="tab-3">Transfer <?= lang('history') ?></li>
                        ...
                        <div id="tab-1" class="MemberTabs-content <?=$tab == 'e_wallet'? 'current' :'' ?>">
                            ...
                            <div class="box">
                                ...
                                <div class="user-info_details">
                                    <h2 class="user-info_username">고객님의 보유 머니</h2>
                                        <ul class="badges">
                                        	<?php if(MG_ENABLE == 'Y'):?>
                                            <li>MG Money&nbsp;&nbsp;: <strong><?= number_format($user -> mg_casino_balance,0)?> <?= lang('cny')?></strong></li>
											<?php endif;?>
											<?php if(PT_ENABLE == 'Y'):?>
                                            <li>PT Money&nbsp;&nbsp;&nbsp;: <strong><?= number_format($user -> pt_casino_balance,0)?> <?= lang('cny')?></strong></li>
											<?php endif;?>
                                        </ul>
                                </div>
	...
	<?php else:?>                                
										...
										<table class="table mb-none">
											<thead>
												<tr height="30px">
													...
													<th class="text-right">입금게임</th>
													<th class="text-right">출금게임</th>
		...
		<?php foreach($histories as $history):?>                                            
												<tr>
													...
													<td class="text-right"><small><?=$history -> transfer_to?></small></td>
													<td class="text-right"><small><?=$history -> transfer_from?></small></td>
...
<?php endif;?>                            
                        ...
                        <div id="tab-3" class="MemberTabs-content <?=$tab == 'history'? 'current' :'' ?>" style ="display:none"> 
