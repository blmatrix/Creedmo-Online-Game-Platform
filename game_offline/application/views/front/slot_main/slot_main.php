...
?>
<script type="text/javascript" src="<?=base_url('assets/'); ?>/js/ProgressiveTickersMandatory.js"></script>
    <!-- container -->
			...
			<div class="sub_banner2">
				...
				<div class="sub_spot_inr">
					<div class="sub_spot_left">
						<h1>마이크로게이밍 슬롯</h1>
						<h2>전 세계 가장 많은 유저들이 즐기는 슬롯게임</h2>
					</div>
...
?>
                ...
                <div id="game_list" class="jplist">
                    ...
                    <div id="list_content" class="jplist-grid-view">
					<div class="total_ticker">
					</div>
					</div>
        ...
        $.ajax({
            ...
            success: function (data) {
                 if (data.errorCode == 0){
                        ...
                        // setTimeout(function(){
                            // $('.slot-jackpot').each(function(){
                                // var el = '<script type="text/javascript" src="https://www.tickerassist.co.uk/ProgressiveTickers/include/js/ProgressiveTickersControl.js?showlogo=false&fontfamily=Arial&font-weight=bold&fontcolor=gold&font-size=13&currency=CNY&progid=15">';
                                // el = el + '<'+'/script>';
                                // $(this).html(el);
                            // }); 
                        // },5000)
