...
define('SETTLEMENT_METHOD_MG_MONEY', "3");
define('SETTLEMENT_METHOD_PT_MONEY', "4");
...
//콤프 포인트 최소 전환율 , MF 입금이 10 단위부터 가능하기 때문에..
define('CONVERT_COMP_MIN_LIMIT',1000);

//게임사 게임 제공 여부 
define('PT_ENABLE','N');
define('MG_ENABLE','Y');

define('CATEGORY_STATUS_Y', 'Y');
define('CATEGORY_STATUS_N', 'N');

define('API_RETRY_COUNT', 3);
define('API_SLEEP_TIME', 2);

define('GAME_PLAY_UPDATE_STATUS_SUCCESS', 'Y');
define('GAME_PLAY_UPDATE_STATUS_FAIL', 'N');
