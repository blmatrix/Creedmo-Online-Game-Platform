...
class __TwigTemplate_7b8f4eeedb2acaa9d18e2dbf895988e1ae3060644fcea8e998777c4f2f6ebcb8 extends Twig_Template
{
            ...
            ";
                ...
                if ( !twig_test_empty($this->getAttribute($context["action"], "url", array()))) {
                    ...
                    if ((($this->getAttribute($context["action"], "type", array()) == "download") || ($this->getAttribute($context["action"], "type", array()) == "outlink"))) {
                        ...
                        echo twig_escape_filter($this->env, $this->getAttribute($context["action"], "type", array()), "html", null, true);
                        echo "\">
                ";
                    }
                    // line 99
