<?php if ($member_tab == 'overview'):?>
                ...
                <div class="well well-sm">
                                            <div class="table-responsive">
                                                <table class="table mb-none">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td>MG Casino</td>
                                                            <td class="text-right"><strong><?= number_format($wallet-> mg_casino_balance);?>  CNY</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td>PT Casino</td>
                                                            <td class="text-right"><strong><?= number_format($wallet-> pt_casino_balance);?>  CNY</strong></td>
                                                        </tr>
                                                        <tr>
                                                            <td>Comp Point</td>
                                        ...
                                        <h4 class="mb-xlg">Personal Information 
                                            <small class ="label pull-right">
                                                <?php if ($user-> mg_game_status == 'Y'):?>
                                                    <?php if (!empty($mg_game_user)):?>
                                                        <a href="" target ="_blnak" id ="mg_play_chek_url">MG Game Play</a>
                                                    <?php endif;?>
                                                <?php endif;?>
                                                &nbsp;&nbsp;
                                        ...
                                        <form action = "<?= site_url('admin/member/member_modify'); ?>"  method = "POST"  target = "hiddenframe" >
                                            ...
                                            <fieldset>
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label">Messenger(<?= $user -> im_type?> )</label>
                                                ...
                                                <hr class="dotted short">
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="profileBio">User Attentiion</label>
...
<?php if ($member_tab == 'affiliate'):?>
                                        ...
                                        <h4 class="mb-xlg">Assigned Agent</h4>
                                            ...
                                            <div class="form-group has-warning">
                                                <label class="col-md-3 control-label">Upper Agent</label>
                                                <div class="col-md-8">
                                                    <div class="input-group input-group-icon">
                                                        <span class="input-group-addon">
                                            ...
                                            <fieldset>
                                                <div class="form-group">
                                                    <label class="col-md-3 control-label" for="profileFirstName">Affiliate Code</label>
                                                    <div class="col-md-8">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select id="img_type" name ="im_type" class="form-control">
                                                          <option value ="QQ" <?= $user-> im_type == 'QQ'? 'selected':''?> >QQ</option>
                                                          <option value ="Skype" <?= $user-> im_type == 'Skype'? 'selected':''?> >Skype</option>
                                                          <option value ="Kakao Talk" <?= $user-> im_type == 'Kakao Talk'? 'selected':''?>>Kakao Talk</option>
                                                        </select>
                                                    </div> 
                                                </div>
                                                <div class="form-group">
