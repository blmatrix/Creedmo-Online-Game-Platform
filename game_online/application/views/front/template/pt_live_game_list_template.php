<!--  PT Live List Template-->
 <?php foreach($pt_lives as $item):?>
        <div class="slot-box ptslot">
           <div  onclick ="<?= generate_click_event($item-> vender_no,$item -> game_code, $game_type,$session_id,0)?>" class='list-item-hover ptslot' style='background:url(<?=asset_game_image($item -> vender_no , '1' , $item -> game_image1)?>) center 0 no-repeat #0f0f0f'>
