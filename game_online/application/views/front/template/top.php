						...
						<div class="AfterLogin">
							...
							<div class="Balance">
								<div class="e-wallet_login">
									<b><?= lang('e_wallet')?> : </b><span><a href="<?= site_url('e_wallet')?>"><?= number_format($user -> wallet_balance,2)?> <?= lang('cny')?></a></span>
									   <a class="PopSignUp T_small fancybox.ajax" href="<?=site_url('e_wallet/deposit')?>">   
									       <?= lang('deposit')?>
									   </a>
								</div>
								<div class="gamemoney_login">
									MG : <span id ="mg_casino_balance"><?= number_format($user -> mg_casino_balance,2)?></span>
									<!-- MG : <span style="display:none" class ="casino_balance" id ="mg_casino_balance">Updating</span>-->
								</div> 
								<div class="gamemoney_login">
									PT : <span id ="pt_casino_balance"><?= number_format($user -> pt_casino_balance,2)?></span> 
						...
						<nav>
							<ul class="navigation">
								<li id="home" class="nvselected">
									<a href="<?= base_url()?>"><i class="flaticon-home113"></i></a>
								</li>
								<li id="livecasino">
									<a href="<?= site_url('slot_main/live')?>"><?= lang('live_casino')?></a>
								</li>
								<li id="mgslot">
									<a href="<?= site_url('slot_main?g_vender='.VENDER_MG)?>"><?= lang('mg_slot')?></a>
								</li>
								<li id="ptslot">
									<a href="<?= site_url('slot_main?g_vender='.VENDER_PT)?>"><?= lang('pt_slot')?></a>
								</li>
							</ul>
						</nav>
						<div class="sub_menu">
