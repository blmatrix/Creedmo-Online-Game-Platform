                        ...
                        <div id="tab-1" class="MemberTabs-content current">
							...
							<div class="box">
								...
								<div class="user-info_btn">
                                    <a href="http://gobigchina.net/index.php/brand" target="_blank" class="button_black banking PopSignUp">Affiliate Reports</a>                             
                                </div>
								<div class="URL_thru"> <i class="flaticon-star174"></i> Direct Your URL 
								    <p><strong><?=base_url('')?>?a_code=<?= $user -> affiliate_code?></strong></p> 
								</div>
							</div>
							
                            <h4>Choose the banners</h4>
                            <p class="info">- To select the most appropriate banners</p>
