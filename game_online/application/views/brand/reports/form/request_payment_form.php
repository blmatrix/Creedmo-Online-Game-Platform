		...
		<div class="col-md-12">
			<ul class="list-group">
				<li class="list-group-item">
					<h4><span  class="pull-right label label-primary" id ="Commission Balance"><?= number_format($wallet -> agent_settlement_balance,2)?></span></h4>
					<strong style ="color:gray" >Agent Commission Balance</strong>
				</li>
			</ul>
			</br>
			<fieldset>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<div class="input-group input-group-icon">
							<span class="input-group-addon"> <span class="icon"><i class="fa fa-user"></i></span> </span>
							<input type="text" class="form-control" placeholder="Request Payment"  id="settlement_amount"  name = "settlement_amount">
						</div>
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-3 control-label"><span class="required">*</span> Withdraw Type</label>
					<div class="col-md-8">
						<div class="input-group input-group-icon" >
							...
							<select class="form-control" id ="settlement_method" name ="settlement_method" style ="margin-bottom:8px">
								...
								<option value ="">&nbsp;&nbsp;&nbsp;-------------------------</option> -->
								<option value = "<?= SETTLEMENT_METHOD_WALLET?>" >&nbsp;&nbsp;&nbsp;Wallet</option>
								<option value = "<?= SETTLEMENT_METHOD_WIRE?>" >&nbsp;&nbsp;&nbsp;Wire Transfer</option>
							</select>
						</div>
...
?>  
	...
	<div class="modal-footer">
		<button type="button" onclick ="startRequestPayment(this)" class="btn btn-primary">confirm</button>
