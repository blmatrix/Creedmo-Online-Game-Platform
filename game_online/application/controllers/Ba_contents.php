...
class Ba_contents extends Application{
    ...
    private function __get_acc_comp_list($page){
        ...
        return $this -> load -> view('front/template/board/accumulate_comp_list',$data, TRUE);
    }
    ...
    private function __get_convert_comp_list($page){
        ...
        return $this -> load -> view('front/template/board/convert_comp_list',$data, TRUE);
    ...
    public function __get_coupon_list($page){
        ...
        return $this -> load -> view("front/template/board/coupon_list",$data, TRUE);
    }
    ...
    public function __get_used_coupon_list($page){
        ...
        $data['rows'] = $this -> coupon -> raw_binding_query($sql, $query_binding);
        return $this -> load -> view("front/template/board/used_coupon_list",$data, TRUE);
    }
}
