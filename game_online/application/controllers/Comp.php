...
class Comp extends Application{
    ...
    public function index(){
        ...
        log_message('error',$search_user_id); 
        ...
        $this -> load -> view('front/comp/comp',$data);
    }
    ...
    public function convert_comp(){
         ...
         if ($this -> input -> method(TRUE) == "POST") {
             ...
             $req_convert_comp_amount = $this -> input -> post('convert_amount');
             $condition[WHERE_CONDITION] = array('user_no' => $user_no);
             ...
             $convert_insert_arr = array(
                ...
                'convert_money' => number_format($req_convert_comp_amount / $user_levels_info[0] -> conversion_1cny_rate,2),
             ...
             $wallet_update_arr = array(
                ...
                'wallet_balance' => $wallet -> wallet_balance  +   $convert_insert_arr['convert_money']
             ); 
             ...
             $this -> load -> view('front/comp/form/convert_comp_form',$data);
         }
    }
