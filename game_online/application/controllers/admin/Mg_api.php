...
class Mg_api extends CI_Controller {
    ...
    public function fetch_game_play(){
        ...
        $condition['start_time'] = "2015-11-03T00:00:00"; 
        $condition['end_time']  =  "2015-11-03T06:00:00";
        $message = ''; 
    ...
    public function get_game_list() {
        ...
        $params = $this -> microgame -> set_params(array('accountNo' => 'BFMGtopayc0011', 'languageId' => 1));
